...
plot "../data/weight/loc1.dat" using 1:3 title 'Empircal k=1'    with linespoints ls 1,  \
     loc1(x)                             title 'Theoretical k=1' with linespoints ls 11, \
     "../data/weight/loc2.dat" using 1:3 title 'Empirical k=2'   with linespoints ls 2,  \
     loc2(x)                             title 'Theoretical k=2' with linespoints ls 22, \
     "../data/weight/loc3.dat" using 1:3 title 'Empirical k=3'   with linespoints ls 3,  \
     loc3(x)                             title 'Theoretical k=3' with linespoints ls 33, \
     "../data/weight/loc4.dat" using 1:3 title 'Empirical k=4'   with linespoints ls 4,  \
     loc4(x)                             title 'Theoretical k=4' with linespoints ls 44
